...
<head>
    ...
    <link rel="stylesheet" href="/WebR/css/contactanos.css"> <link rel="stylesheet" href="responsive.css"> </head>
        ...
        <div class="navbar">
            ...
            <div class="user-menu">
                <?php if (isset($_SESSION['id_cliente'])): ?>
                    ...
                    <a href="http://localhost/AlterWeb/Roles/Cliente.php"> <img src="/WebR/img/loginsinfondo.png" alt="Ver Perfil" class="icono">
                    </a>
                    <a href="logout.php"> <img src="/WebR/img/cerrarsesion1-removebg-preview.png" alt="Cerrar sesión" class="icono">
                    </a>
                <?php else: ?>
    ...
    <footer>
        ...
        <div class="footer-section">
            ...
            <div class="redes-sociales">
                <a href="https://www.facebook.com/TuEmpresa"> <img src="/WebR/img/fb_sinfondo.png" alt="Facebook">
                </a>
                <a href="https://www.tiktok.com/@TuEmpresa"> <img src="/WebR/img/tiktok_sinfondo.png" alt="TikTok">
                </a>
                <a href="https://www.instagram.com/TuEmpresa"> <img src="/WebR/img/logo_insta_sinfondo.png" alt="Instagram">
                </a>
            </div>
        </div>
        <div class="copyright">
